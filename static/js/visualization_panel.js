...
const VizPanel = {
    ...
    init() {
        // Don't connect the /visualization socket at page load.
        // It will be lazily connected when the Visualization tab is activated.
        this.bindEvents();
    },

    // ===== Socket.IO (lazy — only when tab is active) =====
    connectSocket() {
    ...
    onTabActivated() {
        ...
        this.connectSocket();   // Lazy connect on first tab visit
        this.requestUpdate();
        this.startAutoUpdate();
    },
    ...
    onTabDeactivated() {
        ...
        this.stopAutoUpdate();
        this.disconnectSocket(); // Release socket when leaving tab
    },
